...
|RDP (Step 1): Open Local Users and Groups → Navigate to Users → Right-click the user account (HelpDeskUser) → Select Properties → Verify/Edit user details (Full Name, account status) → Click OK. | <a href="https://github.com/user-attachments/assets/7344cd63-5fb8-461e-91c6-302cce547265">Remote Desktop Support</a>|
|RDP (Step 2): Open Local Users and Groups → Groups → Double-click Remote Desktop Users → Add the user (e.g., HelpDeskUser) → Confirm the user appears in the Members list → Click OK. | <a href="https://github.com/user-attachments/assets/195dbfe1-f8e4-493c-9e51-2c0dd6f8823c">Remote Desktop Support</a>|
|RDP (Step 3): Open Command Prompt → Run ipconfig → Note the IPv4 Address (e.g., 192.168.64.4) → Use this IP when initiating the Remote Desktop connection.| <a href="https://github.com/user-attachments/assets/6c6d1b3e-1c30-474d-951b-89a47141b44d">Remote Desktop Support</a>|
|RDP (Step 4): Open Remote Desktop Connection (mstsc) → Enter Computer: 192.168.64.4 → Username: HelpDeskUser → Click Connect → Enter credentials to establish the session. | <a href="https://github.com/user-attachments/assets/ade8cbc6-7491-4ab2-9bda-6bd660b7703b">Remote Desktop Support</a>|
|RDP (Step 5): Enter HelpDeskUser password → Click OK → Remote desktop session established successfully.| <a href="https://github.com/user-attachments/assets/d88a5bbb-4de2-4f7e-a533-79ff31fe939a">Remote Desktop Support</a>|
|RDP (Step 6): When the certificate warning appears → Review the message → Click Yes to trust the connection and proceed.| <a href="https://github.com/user-attachments/assets/752eaec8-4ce0-4ffb-ba30-6b400678e442">Remote Desktop Support</a>|
|RDP (Step 7): After the connection is established, verify successful login to the remote system by confirming access to the desktop under the HelpDeskUser local account.| <a href="https://github.com/user-attachments/assets/1b7e3d87-971d-457b-a877-fff0ff7b455c">Remote Desktop Support</a>|
